...
class RecyclerAdapterImp(
    private var list: List<Images>, private val onDelete: (Images) -> Unit
    ...
    override fun onBindViewHolder(
        ...
        Glide.with(holder.itemView.context).load(image)
            ...
            }).placeholder(android.R.drawable.ic_menu_gallery).centerCrop().into(holder.imageId)
    }

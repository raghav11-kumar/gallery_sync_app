...
class BluetoothAdapter (val list:List<BleDeviceInfo>,val context: Context): RecyclerView.Adapter<BluetoothAdapter.viewHolder>() {
    ...
    override fun onBindViewHolder(
        ...
        holder.itemView.setOnClickListener {
            ReusableFunctions.DefaultAlertDialog(context,"Do You Want To Connect ${data.deviceName}","Yes","No"){
